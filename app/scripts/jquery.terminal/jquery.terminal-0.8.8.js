        ...
        function echo_command(command) {
            ...
            if (typeof prompt === 'function') {
                prompt(function(string) {
                    string = "<span class=\"prompt-history\">" + string + "</span><span></span>&nbsp;";
                    self.echo(string + command, {"raw": true});
                });
            } else {
                prompt = "<span class=\"prompt-history\">" + prompt + "</span><span></span>&nbsp;";
                self.echo(prompt + command, {"raw": true});
            }
        }
        // -----------------------------------------------------------------------
